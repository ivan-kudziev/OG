...
public class GameSettings extends Application {
	...
	private static final String TAG_MUSIC_STATE = "music";
	private static final String TAG_SOUND_STATE = "sound";
	...
	public static void setMusicSound(int pMusic, int pSound) {
		LOAD_MANAGER.saveParam(TAG_SOUND_STATE, String.valueOf(pSound));
		SOUND_VAL = pSound;
		LOAD_MANAGER.saveParam(TAG_MUSIC_STATE, String.valueOf(pMusic));
		MUSIC_VAL = pMusic;

	}

	public static void getMusicSound() {
		SOUND_VAL = Integer.valueOf(LOAD_MANAGER.getStringParam(TAG_SOUND_STATE));
		MUSIC_VAL = Integer.valueOf(LOAD_MANAGER.getStringParam(TAG_MUSIC_STATE));
